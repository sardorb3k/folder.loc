...
<body>
    ...
    <div id="fullpage">
            ...
            <div class="inside-section">
                <div class="inside-content">
                    ...
                    <h1 class="cd-headline zoom">
                        <span class="cd-words-wrapper"><b class="is-visible">
                                Hayot Tarzingizda<br />
                                Kichik
                                <span class="highlight">O'zgarishlar</span>
                                <br />
                                Qilishmi </b><b>Insonlarga <br />
                                Ozgina
        ...
        <div class="section" id="section1">
                ...
                <div class="inside-content double-col container">
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-lg-5 with-border">
                            <h2>
                                1<span class="number">.</span> O'qing<small>Ushbu ajoyib universitetning bir qismi
                                    bo'lish bu -</small>
                            </h2>
                            <div class="text">
                                <p class="subtitle">
                                    ...
                                    inson bo'lish demakdir.<br /><br /><strong>Insonlarning bilimga bo'lgan muhabbatini
                                        uyg'otish</strong>
                        ...
                        <div class="col-xs-12 col-md-6 col-md-push-0 col-lg-6 col-lg-push-1">
                            <h2>
                                2<span class="number">.</span> A'zo bo'ling<small>Ajoyib o'zgarishlarni amalga
                                    oshiring</small>
                            </h2>
                            <div class="text">
                                <ul>
                                ...
                                <div id="subscribe">
                                    <form action="#" id="notifyMe" method="POST">
                                        <div class="form-group">
                                            <div class="controls">
                                                <input type="text" id="mail-sub" name="phone"
            ...
            <a class="ibtn light-btn hidden-xs hidden-sm" href="#3">Biz bilan bog'laning!</a>
        </div>
        <div class="section" id="section2">
                        ...
                        <form id="contact-form" name="contact-form" method="POST" data-name="Contact Form">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-lg-12 display-none">
                                    <div class="form-group">
                                        <input type="text" id="checking" class="form form-control"
                                            placeholder="Leave this field empty" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Leave this field empty'" name="checking"
                                            data-name="Checking" />
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form form-control"
                                            placeholder="Ismingiz*" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Ismingiz*'" name="name"
                                            data-name="Ismingiz" required />
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        <i class="fa fa-phone icon-fields"></i>
                                        <input type="phone" id="phone" class="form form-control"
                                            placeholder="Telefon raqamingiz*" onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Telefon raqamingiz*'" name="phone-number"
                                            data-name="Telefon raqamingiz" required />
                                    </div>
                                </div>
                                <!-- <div class="col-xs-12 col-sm-12 col-lg-12">
                        ...
                        <option value="Just saying Hi!">Just saying Hi!</option>
                                ...
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="text-area" class="form textarea form-control" placeholder="Xabaringiz*..."
                                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your message here*... 20 characters Min.'"
                                            name="message" data-name="Text Area" required></textarea>
                                    </div>
                                    <span class="sub-text">* majburiy</span>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <input type="checkbox" id="ios" name="newsletter" value="Yes"
                                        checked />
                                    <label for="ios" class="ios button"></label>
                                    <label class="check-news">Haftalik yangiliklardan xabardor bo'lmoqchiman.</label>
                                </div>
                            </div>
            ...
            <a class="ibtn light-btn back-home hidden-xs hidden-sm" href="#1"><i class="fa fa-home"></i></a>
        </div>
    </div>
    ...
    <div class="social-nav">
        <ul>
            <li>
                <a href="https://t.me/luna_university" target="_blank"><i class="fa fa-paper-plane"></i></a>
            </li>
            <li>
                <a href="https://www.youtube.com/channel/UCJFA7M2SnvbWIeC68oXunNg" target="_blank"><i
                        class="fa fa-youtube-play"></i></a>
            </li>
            <li>
                <a href="https://www.instagram.com/luna_university/" target="_blank"><i
