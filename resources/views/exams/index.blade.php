        ...
        <tbody>
            @foreach ($exams as $exam)
                <tr class="nk-tb-item odd">
                    ...
                    <td class="nk-tb-col">
                        <span class="badge bg-primary">{{ $exam->accepted }}</span>
                        <span class="badge bg-danger">{{ $exam->notaccepted }}</span>
                    </td>
                    <td class="nk-tb-col">
                        <span class="badge bg-primary">{{ date("d-M-Y", strtotime($exam->created_at)) }}</span>
                    </td>
                    @if (Auth::user()->role == 'superadmin')
