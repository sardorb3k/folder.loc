            ...
            this.jKanban = function () {
                ...
                this.addBoards = function (boards, isInit) {
                    ...
                    for (var boardkey in boards) {
                        ...
                        var headerTitleBoardContainer = document.createElement('div')
                        ...
                        if (addButton) {
                            ...
                            var dropdownMenuList = document.createElement('ul')
                            ...
                            dropdownMenuList.classList.add('link-list-opt', 'no-bdr', 'kanban-title-action')
                            editButton.classList.add('cursor-pointer')
                            removeButton.classList.add('cursor-pointer')
                            editButton.setAttribute('id', 'edit-button')
                            removeButton.setAttribute('id', 'remove-button')
                            editButton.innerHTML = `<a class="edit-board"><em class='icon ni ni-edit'></em><span>Edit Board</span></a>`
                            removeButton.innerHTML = `<a class="remove-board"><em class='icon ni ni-trash'></em><span>Remove Board</span></a>`
                            buttonsContainer.appendChild(dropdownButtonContainer)
                            dropdownButtonContainer.appendChild(dropdownMenuContainer)
                            dropdownMenuContainer.appendChild(dropdownMenuList)
                            if (buttonContent.includes(':')) {
                                dropdownMenuList.appendChild(editButton)
                            }
                            if (buttonContent.includes('-')) {
                                dropdownMenuList.appendChild(removeButton)
                            }

                            if (buttonFooter) {
                                footerBoard.appendChild(btn)
                            } else {
                                headerTitleBoardContainer.appendChild(buttonsContainer)
                            }
                            __onButtonClickHandler(editButton, board.id)
                            __onButtonClickHandler(removeButton, board.id)
                        }
                        //board assembly
